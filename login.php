...
<body>
    ...
    <img src="images/banner.jpg" alt="Concert Background" style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; z-index: -1; object-fit: cover;">
    ...
    <main style="text-align: center;">
		...
		<div style="width: 50%; margin: auto; padding: 10px; background-color: rgba(255, 255, 255); border-radius: 8px; display: flex; justify-content: center; gap: 20px;">
			<div style="display: flex; flex-direction: column; align-items: center; text-align: center;">
				<img src="images/blackpink.jpg" alt="Blackpink" style="width: 150px; height: auto;">
				<h3>Blackpink</h3>
			</div>
			<div style="display: flex; flex-direction: column; align-items: center; text-align: center;">
				<img src="images/theweeknd.jpg" alt="The Weeknd" style="width: 150px; height: auto;">
				<h3>The Weeknd</h3>
			</div>
			<div style="display: flex; flex-direction: column; align-items: center; text-align: center;">
				<img src="images/LDR.jpg" alt="Lana Del Rey" style="width: 150px; height: auto;">
				<h3>Lana Del Rey</h3>
			</div>
		</div>
    </main>
